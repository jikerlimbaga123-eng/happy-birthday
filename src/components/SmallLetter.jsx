...
const SmallLetter = () => {
    ...
    <div className="small-rajib-paper-content">
        ...
        <p>Hello Larshy,<br /><br />uhm first of all gusto kitang batiin ng magandang kaarawan sana nag enjoy ka ngayon sa araw mo and I pray that you win in life, achieve all your dreams and get everyting you want. <br /><br />Your Friend,<br />Jekier</p>
    </div>
