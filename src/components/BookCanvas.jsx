...
const BookCanvas = ({ active, setActive }) => {
    ...
    <article style={{ marginBottom: '5px' }}>First of all gusto kitang batiin ng Happy Birthday, Lar❤️</article>
    <article style={{ marginBottom: '5px' }}>Ang message ko sayo is stay humble and continue being the kind and genuine person that you are.</article>
    <article style={{ marginBottom: '5px' }}>Huwag mong hayaan na mawala yung magandang personality mo kasi isa yan sa nagpapaganda lalo sayo😊.</article>
    <article style={{ marginBottom: '5px' }}>Again, Happy Birthday and sana maging masaya at memorable yung araw mo today. Stay safe always and keep smiling kasi bagay sayo na nakangiti😁. </article>
</div>
